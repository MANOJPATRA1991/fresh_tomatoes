...
the_avengers = media.Movie(
    "The Avengers",
    "S.H.I.E.L.D. leader Nick Fury is compelled to launch "
    "the 'Avengers Initiative' when Loki poses a threat to "
    "planet Earth. Will Nick Fury's squad of superheroes "
...
nightcrawler = media.Movie(
    "Nightcrawler",
    "Lou Bloom wants to set a score with his rival Joe Loder "
    ...
    [
        ...
        "with a career-peak turn from Jake Gyllenhaal. "
